...
class ConvolutionalAutoencoderHighRes(L.LightningModule):
    ...
    def __init__(
        ...
        self.conv01 = nn.Conv3d(
            in_channels=2, out_channels=128,
            kernel_size=(3, 3, 3), stride=1, padding=1)  # 128x128x128
        self.pool01 = nn.MaxPool3d(
            kernel_size=(2, 2, 2), stride=2, padding=0)  # 64x64x64
        self.conv11 = nn.Conv3d(
            in_channels=128, out_channels=64,
            kernel_size=(3, 3, 3), stride=1, padding=1)  # 64x64x64
        self.pool11 = nn.MaxPool3d(
            kernel_size=(2, 2, 2), stride=2, padding=0)  # 32x32x32
        self.conv21 = nn.Conv3d(
            in_channels=64, out_channels=32,
            kernel_size=(3, 3, 3), stride=1, padding=1)  # 32x32x32
        self.pool21 = nn.MaxPool3d(
            kernel_size=(2, 2, 2), stride=2, padding=0)  # 16x16x16
